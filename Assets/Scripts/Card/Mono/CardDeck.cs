...
namespace Card.Mono
{
    public class CardDeck : MonoBehaviour {
        ...
        private List<global::Card.Mono.Card> handCardObjectList = new();//当前手牌
        ...
        public void DrawCard(int amount)
        {
            ...
            for (int i = 0; i < amount; i++)
            {
                ...
                var card = cardManager.GetCardObject().GetComponent<global::Card.Mono.Card>();
        ...
        {
            global::Card.Mono.Card card = obj as global::Card.Mono.Card;
